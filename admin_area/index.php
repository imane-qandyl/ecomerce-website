      ...
      <div class="row">
          <div class="col-md-12 bg-secondary p-1 d-flex align-items-center">
              ...
              <div class="button text-center">
                  ...
                  <button classe="my-3"><a href="" class="nav-link text-light bg-info my-1">view product</a></button>
                  ...
                  <button classe="my-3"><a href="" class="nav-link text-light bg-info my-1">list users</a></button>
