...
$poduct_title=$_POST['product_title'];
$description=$_POST['description'];
$poduct_keywords=$_POST['product_keywords'];
$poduct_categorie=$_POST['product_categorie'];
$poduct_brands=$_POST['product_brands'];
$poduct_price=$_POST['product_price'];
$product_status='true';

$poduct_image1=$_FILES['product_image1']['name'];
$poduct_image2=$_FILES['product_image2']['name'];
$poduct_image3=$_FILES['product_image3']['name'];

$temp_image1=$_FILES['product_image1']['tmp_name'];
$temp_image2=$_FILES['product_image2']['tmp_name'];
$temp_image3=$_FILES['product_image3']['tmp_name'];

if($product_title=='' or $description=='' or $product_keywords=='' or $product_categorie=='' or $product_brand=='' or $product_price=='' or $poduct_image1=='' or $poduct_image2=='' or $poduct_image3=='' ){
...
exit();
    ...
    $insert_product="insert into `products` (product_title,product_description,product_keywords,categorie_id,brand_id,product_image1,product_image2,product_image3,product_price,date,status) 
    values('$product_title','$description','$poduct_keywords','$poduct_categorie','$poduct_brands','$poduct_price','$poduct_image1','$temp_image2','$temp_image3','NOW()','$product_status')";
    $result_query=mysqli_query($con,$insert_products);
    if($result_query){
        echo "<script>zlert('successfuly inserted the product')</script>";
    }
}}
?>
<!DOCTYPE html>
...
<select name="product_brands" class="form-select mt-3" aria-label="Default select example">
       ...
       while($row=mysqli_fetch_assoc($result_query)){
           ...
           echo"<option value='$brand_id'>$categorie_title</option>";
       }
       ?>
    </select>
</div>
...
<div class="form-outline mb-4 w-50 m-auto">
  <input type="submit"name="insert_product"class="btn btn-info mt-3 px-3" value="insert product">
</div>
        </form>
    </div>
</body>
